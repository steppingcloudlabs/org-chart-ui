      ...
      <v-card flat class="drawer-card">
        ...
        >
          ...
          <v-card-text>
            ...
            <div
              v-html="
                drawer.jobProfileData?.shortDesciptions?.results?.[0]
                  ?.desc_defaultValue
              "
            />
            <v-divider class="my-3" />
            <div
              v-html="
                drawer.jobProfileData?.longDesciptions?.results?.[0]
                  ?.desc_localized
              "
            />
            <v-divider class="my-3" />
            ...
            <v-chip-group column>
              <v-chip
                v-for="(skill, i) in drawer.jobProfileData?.competencyContents
                  ?.results || []"
                :key="i"
                small
                outlined
